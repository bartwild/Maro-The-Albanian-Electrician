...
public:
	...
	void draw_map(const bool background, unsigned viewX, sf::RenderWindow& aWindow, sf::Color& backgroundColor, const sf::Texture& aMapTexture, const sf::Texture& aQuestionBlock, const Map& aMap);
	...
	Map sketch_to_map(Maro& aMaro, unsigned char& finish, sf::Color& backgroundColor, std::vector<Roomba>& aRoombas);
